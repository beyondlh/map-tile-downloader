...
public class GenericTileProvider implements TileProvider
{
    ...
    /**
     * @see TileProvider#getTileUrl(Tile)
     */
    @Override
    ...
    /**
     * @see TileProvider#getTileServerUrl()
     */
    @Override
    ...
    /**
     * @see TileProvider#getTileFilename(Tile)
     */
    @Override
